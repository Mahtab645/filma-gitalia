...
<section class="home-collection" id="products">
    <div class="container">
        ...
        <div class="collection-grid">
            ...
            $icons = [
                'return-bend' => '<svg viewBox="0 0 200 180" fill="none" aria-hidden="true"><path d="M58 22v52c0 23.2 18.8 42 42 42s42-18.8 42-42V22" stroke="#111" stroke-width="2.2"/><path d="M70 22v52c0 16.6 13.4 30 30 30s30-13.4 30-30V22" stroke="#111" stroke-width="2.2"/><path d="M46 22h24M130 22h24" stroke="#111" stroke-width="2.2"/><path d="M100 22v118" stroke="#111" stroke-width="1" stroke-dasharray="3 3"/><text x="38" y="18" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">A</text><text x="156" y="18" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">A</text><text x="104" y="148" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">O</text></svg>',
                'elbow-90' => '<svg viewBox="0 0 200 180" fill="none" aria-hidden="true"><path d="M52 24v50c0 27.6 22.4 50 50 50h54" stroke="#111" stroke-width="2.2"/><path d="M64 24v50c0 21 17 38 38 38h54" stroke="#111" stroke-width="2.2"/><path d="M40 24h24M156 112v24" stroke="#111" stroke-width="2.2"/><path d="M102 24v50M156 124H102" stroke="#111" stroke-width="1" stroke-dasharray="3 3"/><text x="32" y="20" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">A</text><text x="162" y="148" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">B</text><text x="70" y="86" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">R</text></svg>',
                'elbow-45' => '<svg viewBox="0 0 200 180" fill="none" aria-hidden="true"><path d="M58 22v44c0 16 6.5 30.5 18 41.5L122 154" stroke="#111" stroke-width="2.2"/><path d="M70 22v44c0 11.2 4.6 21.4 12.6 29.2L128 148" stroke="#111" stroke-width="2.2"/><path d="M46 22h24M114 147l17 17" stroke="#111" stroke-width="2.2"/><text x="38" y="18" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">A</text><text x="136" y="168" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">B</text><text x="62" y="84" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">C</text></svg>',
                'tee' => '<svg viewBox="0 0 200 180" fill="none" aria-hidden="true"><path d="M28 70h144M92 70v72M108 70v72" stroke="#111" stroke-width="2.2"/><path d="M28 58v24M172 58v24M80 142h40" stroke="#111" stroke-width="2.2"/><path d="M100 58v96" stroke="#111" stroke-width="1" stroke-dasharray="3 3"/><text x="22" y="52" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">A</text><text x="174" y="52" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">A</text><text x="112" y="164" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">M</text></svg>',
                'reducer' => '<svg viewBox="0 0 200 180" fill="none" aria-hidden="true"><path d="M24 48h44l56 64h52M24 72h44l56 40h52" stroke="#111" stroke-width="2.2"/><path d="M24 48v24M176 112v40" stroke="#111" stroke-width="2.2"/><text x="16" y="42" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">D</text><text x="178" y="108" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">D1</text><text x="96" y="78" fill="#111" font-size="10" font-family="Roboto, Arial, sans-serif">H</text></svg>',
            ];
